(function (app) {
    ...
    applicationGroupsAddController.$inject = ['$scope', 'apiService', 'notificationService', '$location', 'commonService'];

    function applicationGroupsAddController($scope, apiService, notificationService, $location, commonService) {
        $scope.group = {
            ID: 0,
            Roles: []
        }
...
})(angular.module('nnshop.application_groups'));