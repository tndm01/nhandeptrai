...
(function (app) {
    ...
    function revenueStatisticController($scope, apiService, notificationService, $filter) {
        ...
        function getStatistic() {
            ...
            apiService.get('api/statistic/getrevanue?fromDate=' + config.param.fromDate + "&toDate=" + config.param.toDate, null, function (response) {
...
})(angular.module('nnshop.statistic'));