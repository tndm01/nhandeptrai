(function (app) {
    ...
    applicationUserListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$stateParams'];

    function applicationUserListController($scope, apiService, notificationService, $ngBootbox, $stateParams) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
...
})(angular.module('nnshop.application_users'));